...
с помощью расстояния можно делать симметричные штуки
...
[!основано на материале этого туториала!](https://catlikecoding.com/unity/tutorials/basics/mathematical-surfaces/)
